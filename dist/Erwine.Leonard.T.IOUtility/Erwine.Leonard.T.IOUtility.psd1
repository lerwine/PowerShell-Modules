...
FileList = @('README.md', 'about_Erwine.Leonard.T.IOUtility.help.txt', 'IOUtility.tests.ps1', 'Test-CharacterClass.tests.ps1', 'Subby/Example.Txt', 'Subby/Subber/Another.txt')
