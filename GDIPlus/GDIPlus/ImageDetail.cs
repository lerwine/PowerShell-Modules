...
namespace Erwine.Leonard.T.GDIPlus
{
    public class ImageDetail : ImageInfo
    {
        ...
        public void Add(ExifPropertyTag key, PSObject value)
        {
        ...
        public bool TryGetValue(ExifPropertyTag key, out PSObject value)
        {
            return _innerDictionary.TryGetValue(key, out value);
        }

        public void Add(KeyValuePair<ExifPropertyTag, PSObject> item)
        {
        ...
        public bool Contains(KeyValuePair<ExifPropertyTag, PSObject> item)
        {
            return _innerDictionary.Contains(item);
        }

        public void CopyTo(KeyValuePair<ExifPropertyTag, PSObject>[] array, int arrayIndex)
        {
            _innerDictionary.CopyTo(array, arrayIndex);
        }

        public bool Remove(KeyValuePair<ExifPropertyTag, PSObject> item)
        {
            return _innerDictionary.Remove(item);
        }

        public IEnumerator<KeyValuePair<ExifPropertyTag, PSObject>> GetEnumerator()
        {
