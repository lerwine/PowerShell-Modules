...
namespace UnitTests
{
    ...
    public class XmlUtilityUnitTest
    {
        ...
        public const string RelativeModulePath = @"Deployment\XmlUtility";
        ...
        [TestMethod]
        [TestCategory("XmlUtility")]
        [Description("Tests loading the XmlUtility module.")]
        public void ImportXmlUtilityTestMethod()
        {
            PSModuleInfo module = PowerShellHelper.LoadPSModuleFromDeploymentDir(TestContext, "XmlUtility\\Erwine.Leonard.T.XmlUtility.psd1");
