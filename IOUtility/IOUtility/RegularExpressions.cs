    ...
    public static class RegularExpressions
    {
        ...
        static RegularExpressions()
        {
            RegularExpressions.InvalidFileNameChars = new Regex(String.Format(@"(_(?=0x[\dA-F]{4}_)|{0})",
                TextHelper.GetRegexPattern(null, Path.GetInvalidFileNameChars(), false, false), RegexOptions.Compiled));
            ...
            RegularExpressions.InvalidPathChars = new Regex(String.Format(@"(_(?=0x[\dA-F]{4}_)|{0})",
                TextHelper.GetRegexPattern(null, invalidChars, false, false)), RegexOptions.Compiled);
