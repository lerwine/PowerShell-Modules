...
{
    public class PSInvocationBuilderBase<TResult, TAsyncResult>
        where TResult : PSInvocationResult
        where TAsyncResult : PSAsyncInvocationResult<TResult>
    {
        protected PSInvocationBuilderBase()
        {
        ...
        /// </summary>
        public virtual ApartmentState ApartmentState { get; set; }

        /// <summary>
        /// Indicates how threads are handled when the pipeline is invoked.
        /// </summary>
        public virtual PSThreadOptions ThreadOptions { get; set; }
        ...
        protected PowerShell CreatePowerShell(Runspace runspace)
        {
            ...
            AfterAddPipelineItems(powershell, runspace);
            return powershell;
        }

        protected virtual void BeforeAddPipelineItems(PowerShell powershell, Runspace runspace) { }
