...
Function Convert-ToJsonObject {
    ...
    Process {
        ...
        [Markdig.Renderers.Html.HtmlAttributes]$HtmlAttributes = [Markdig.Renderers.Html.HtmlAttributesExtensions]::TryGetAttributes($InputObject);
        ...
        $ElementJson = [System.Text.Json.Nodes.JsonObject]::new();
        $ElementJson.Add('Name', [System.Text.Json.Nodes.JsonValue]::Create($InputObject.GetType().Name));
        $ElementJson.Add('Position', $Position);
        if ($InputObject -is [Markdig.Syntax.Block]) {
            [Markdig.Syntax.Block]$Block = $InputObject;
            ...
            if ($Block -is [Markdig.Syntax.ContainerBlock]) {
                ...
                $Position.Add('Line', [System.Text.Json.Nodes.JsonValue]::Create($ContainerBlock.Line));
                $Position.Add('Column', [System.Text.Json.Nodes.JsonValue]::Create($ContainerBlock.Column));
                $Position.Add('Start', [System.Text.Json.Nodes.JsonValue]::Create($ContainerBlock.Span.Start));
                $Position.Add('End', [System.Text.Json.Nodes.JsonValue]::Create($ContainerBlock.Span.End));
                        ...
                        if ($ContainerBlock -is [Markdig.Extensions.Tables.TableRow]) {
                            ...
                            if ($ContainerBlock -is [Markdig.Extensions.Footnotes.Footnote]) {
                                ...
                                if ($ContainerBlock -is [Markdig.Extensions.CustomContainers.CustomContainer]) {
                                    ...
                                    if ($null -ne $CustomContainer.Arguments) {
                                    ...
                                    if ($null -ne $CustomContainer.Info) {
                ...
                ($ContainerBlock | Convert-ToJsonObject -Level $InnerLevel) | ForEach-Object { $ChildObjects.Add($_) }
            } else {
                if ($Block -is [Markdig.Syntax.LeafBlock]) {
                    ...
                    if ($LeafBlock -is [Markdig.Syntax.CodeBlock]) {
                        ...
                        if ($CodeBlock -is [Markdig.Syntax.FencedCodeBlock]) {
                            ...
                            if ($null -ne $FencedCodeBlock.Info) {
                            ...
                            if ($null -ne $FencedCodeBlock.Arguments) {
                            ...
                            if ($LeafBlock -is [Markdig.Syntax.HeadingBlock]) {
                                ...
                                if ($LeafBlock -is [Markdig.Extensions.Abbreviations.Abbreviation]) {
                                    ...
                                    if ($LeafBlock -is [Markdig.Syntax.LinkReferenceDefinition]) {
                                        ...
                                        if ($null -ne $LinkReferenceDefinition.Title) {
                    ...
                    if ($null -ne $LeafBlock.Inline) {
                        ...
                        for ($c = $LeafBlock.Inline.FirstChild; $null -ne $c; $c = $c.NextSibling) {
                            $si++;
                            $ChildObjects.Add((Convert-ToJsonObject -InputObject $c -Level $InnerLevel -StartIndex $si));
                        }
                    }
                }
            }
            ...
            if ($InputObject -is [Markdig.Syntax.Inlines.Inline]) {
                [Markdig.Syntax.Inlines.Inline]$Inline =  $InputObject;
            ...
            } else { # $InputObject -isnot [Markdig.Syntax.Inlines.Inline]
                if (-not $InputObject.Span.IsEmpty) {
                    $Position.Add('Line', [System.Text.Json.Nodes.JsonValue]::Create($InputObject.Line));
                    $Position.Add('Column', [System.Text.Json.Nodes.JsonValue]::Create($InputObject.Column));
                    $Position.Add('Start', [System.Text.Json.Nodes.JsonValue]::Create($InputObject.Span.Start));
                    $Position.Add('End', [System.Text.Json.Nodes.JsonValue]::Create($InputObject.Span.End));
                }
            }
        }
...
Function Write-ExampleMarkdownInfo {
    ...
    Process {
        ...
        if ($null -ne $MarkdownDocument) {
            ...
            ($MarkdownDocument | Convert-ToJsonObject -Level 1) | ForEach-Object {
                $Tokens.Add($_);
            }
            ...
            try {
                $Writer = [System.Text.Json.Utf8JsonWriter]::new($FileStream);
